 ...
 */
package uyun.xianglong.examples.sclaz.test
...
import uyun.xianglong.examples.sclaz.http.{HttpReceiverSource, TcpReceiverSource}
...
object StreamSqlExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val result: Table = tEnv.sqlQuery("SELECT * FROM OrderA WHERE amount > 2")
