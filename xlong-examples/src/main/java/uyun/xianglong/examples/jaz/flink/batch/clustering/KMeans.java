...
package uyun.xianglong.examples.jaz.flink.batch.clustering;
...
import uyun.xianglong.examples.jaz.flink.batch.clustering.util.KMeansData;
 ...
 * If no parameters are provided, the program is run with default data from {@link uyun.xianglong.examples.jaz.flink.batch.clustering.util.KMeansData} and 10 iterations.
 *
