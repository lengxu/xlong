...
package uyun.xianglong.examples.jaz.flink.batch.graph;
...
import uyun.xianglong.examples.jaz.flink.batch.graph.util.EnumTrianglesData;
import uyun.xianglong.examples.jaz.flink.batch.graph.util.EnumTrianglesDataTypes.Edge;
import uyun.xianglong.examples.jaz.flink.batch.graph.util.EnumTrianglesDataTypes.Triad;
