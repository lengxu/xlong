...
import uyun.xianglong.examples.jaz.flink.batch.graph.util.PageRankData
 ...
 * [[uyun.xianglong.examples.jaz.flink.batch.graph.util.PageRankData]] and 10 iterations.
 * 
